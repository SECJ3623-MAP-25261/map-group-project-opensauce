...
void showCancelConfirmationModal({
  ...
  required Future<void> Function(ItemModel item) onConfirm,
}) {
  showDialog(
    context: context,
...
class CancelOrderWidget extends StatefulWidget {
  ...
  final Future<void> Function(ItemModel item) onConfirm;
    ...
    return AlertDialog(
      ...
      content: SingleChildScrollView(
        child: ListBody(
          children: <Widget>[
            Text(
              'Are you sure you want to cancel order ${widget.item.title}?',
