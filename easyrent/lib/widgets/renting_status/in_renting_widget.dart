...
import 'package:easyrent/widgets/renting_status/inrenting_card_widget.dart';
import 'package:firebase_auth/firebase_auth.dart';
import 'package:flutter/material.dart';

class InRentingWidget extends StatefulWidget {
  const InRentingWidget({super.key});

  @override
  State<InRentingWidget> createState() => _InRentingWidgetState();
}

class _InRentingWidgetState extends State<InRentingWidget> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      body: StreamBuilder<List<Map<String, dynamic>>>(
        stream: _service.getInRentingItems(currentUserId), // Changed to Future
