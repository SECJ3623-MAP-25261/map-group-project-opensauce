...
class HistoryItemCardWidgets extends ConsumerStatefulWidget {
  ...
  @override
  ConsumerState<HistoryItemCardWidgets> createState() =>
      _HistoryItemCardWidgetsState();
}

class _HistoryItemCardWidgetsState
    extends ConsumerState<HistoryItemCardWidgets> {
                          ...
                          children: [
                            SizedBox(
                              ...
                              child: ElevatedButton(
                                onPressed:
                                    historyItemState.getHasReviewed(
                                          widget.item.id,
                                        )
                                        ? null
                                        : () {
