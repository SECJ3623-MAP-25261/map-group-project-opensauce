...
import 'package:easyrent/features/rentee/productDetails/product_details_page.dart';
import 'package:easyrent/features/rentee/productList/product_list_page.dart';
import 'package:easyrent/features/rentee/productList/top_rated_product_page.dart';
import 'package:easyrent/features/rentee/services/database_service.dart';
import 'package:flutter/material.dart';

class TopRentedListWidget extends StatefulWidget {
  final String title;
  final bool isYellowBackground;

  const TopRentedListWidget({
    super.key,
    required this.title,
  ...
  @override
  State<TopRentedListWidget> createState() => _TopRentedListWidgetState();
}

class _TopRentedListWidgetState extends State<TopRentedListWidget> {
                ...
                GestureDetector(
                  onTap: () {
                    Navigator.push(
                      ...
                      MaterialPageRoute(
                        builder:
                            (context) =>  TopRatedProductPage(title: widget.title) 
                      ),
                    );
                  },
                  child: const Icon(
